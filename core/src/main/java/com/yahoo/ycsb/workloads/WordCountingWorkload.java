...
/**
 * The word counting benchmark scenario. Represents a set of clients doing
 * simple CRUD operations. The relative proportion of different kinds of
 * operations, and other properties of the workload, are controlled by
 ...
 * </ul>
 */
public class WordCountingWorkload extends Workload {
  /**
   ...
   */
  protected StringGenerator fieldlengthgenerator;
   ...
   */
  public static final String INSERTION_RETRY_LIMIT = "word_counting_workload_insertion_retry_limit";
  public static final String INSERTION_RETRY_LIMIT_DEFAULT = "0";

  /**
   * On average, how long to wait between the retries, in seconds.
   */
  public static final String INSERTION_RETRY_INTERVAL = "word_counting_workload_insertion_retry_interval";
  ...
  protected static StringGenerator getFieldLengthGenerator(Properties p) throws WorkloadException {
    StringGenerator fieldlengthgenerator;
    ...
    if (fieldlengthdistribution.compareTo("constant") == 0) {
      fieldlengthgenerator = new ConstantStringGenerator(fieldlength);
    } else if (fieldlengthdistribution.compareTo("random") == 0) {
      fieldlengthgenerator = new RandomStringGenerator(fieldlength);
    } else {
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    fieldlengthgenerator = WordCountingWorkload.getFieldLengthGenerator(p);
  ...
  private HashMap<String, ByteIterator> buildSingleValue(String key) {
    ...
    ByteIterator data;
    data = new StringByteIterator(fieldlengthgenerator.nextValue());
  ...
  protected void verifyRow(String key, HashMap<String, ByteIterator> cells) {
    ...
    if (!cells.isEmpty()) {
      for (Map.Entry<String, ByteIterator> entry : cells.entrySet()) {
        if (!entry.getValue().toString().equals(fieldlengthgenerator.nextValue())) {
